...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'Lake Mary' },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'Orlando' }
    ]
};
...
// initialize Firestore and set project id from env var here
